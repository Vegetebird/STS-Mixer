...
action_name = ['high arm wave', 'horiontal arm wave', 'hammer', 'hand catch', 'forward punch', 'high throw', 'draw x', 
'draw tick', 'draw circle', 'hand clap', 'two hand wave', 'side-boxing', 'bend', 'forward kick', 'side kick', 
'jogging', 'tennis', 'swing', 'tennis serve', 'golf swing', 'pickup & throw']
